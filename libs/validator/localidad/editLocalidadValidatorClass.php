...
namespace mvc\validator {
   ...
   */
  class editLocalidadValidatorClass extends validatorClass {
    ...
    public static function validateEdit($nombre,$id) {
      ...
      if ($flag === true) {
        ...
        request::getInstance()->addParamGet(array(\localidadTableClass::ID => $id));
        routing::getInstance()->forward('localidad', 'edit');
      }
    }
