...
class editActionClass extends controllerClass implements controllerActionInterface {
  ...
  public function execute() {
    try {
      if (request::getInstance()->hasGet(sliderImageTableClass::ID)) {
        $fields = array(
        ...
        $where = array(
            sliderImageTableClass::ID => request::getInstance()->getGet(sliderImageTableClass::ID)
        );
        ...
        $this->defineView('edit', 'slider', session::getInstance()->getFormatOutput());
