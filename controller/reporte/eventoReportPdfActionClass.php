 ...
 */
class eventoReportPdfActionClass extends controllerClass implements controllerActionInterface {

    public function execute() {
        try {
            $this->objEventoCate = unserialize(session::getInstance()->getAttribute('objEvento'));
