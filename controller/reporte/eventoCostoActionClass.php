 ...
 */
class eventoCostoActionClass extends controllerClass implements controllerActionInterface {
...
//            $this->objreporte = reporteTableClass::getAll($fields1, false, $orderBy, 'ASC');
            $this->defineView('eventoCosto', 'reporte', session::getInstance()->getFormatOutput());
