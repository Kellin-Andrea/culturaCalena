...
class editActionClass extends controllerClass implements controllerActionInterface {
  ...
  public function execute() {
    try {
      if (request::getInstance()->hasGet(reporteTableClass::ID)) {
        $fields = array(
        ...
        $where = array(
            reporteTableClass::ID => request::getInstance()->getGet(reporteTableClass::ID)
        );
        $this->objreporte = reporte::getAll($fields, false, null, null, null, null, $where);
        $this->defineView('edit', 'reporte', session::getInstance()->getFormatOutput());
      } else {
