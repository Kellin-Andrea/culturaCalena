...
*/
class recaudoEconomicoTableClass extends recaudoEconomicoBaseTableClass {
  
         public static function getTotalpages($lines, $where) {
        try {
            $sql = 'SELECT count (' . recaudoEconomicoTableClass::ID . ') AS cantidad ' .
                    'FROM ' . recaudoEconomicoTableClass::getNameTable(). ' ' .
                     ' WHERE '. recaudoEconomicoTableClass::DELETED_AT . ' IS NULL ';
