...
*/
class patrocinadorTableClass extends patrocinadorBaseTableClass {
  
      public static function getNombreById($id) {
      try {
          $sql = 'SELECT nombre AS nombre ' .
                    'FROM ' . patrocinadorTableClass::getNameTable() .
                    ' WHERE  ' . patrocinadorTableClass::ID . ' = :id';
      ...
      public static function getTotalpages($lines, $where) {
        try {
            $sql = 'SELECT count (' . patrocinadorTableClass::ID . ') AS cantidad ' .
                    'FROM ' . patrocinadorTableClass::getNameTable(). ' ' .
                     ' WHERE '. patrocinadorTableClass::DELETED_AT . ' IS NULL ';
