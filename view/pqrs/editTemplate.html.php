...
<?php view::includePartial('pqrs/formUser', array('objpqrs' => $objpqrs, 'pqrs' => $pqrs, 'objtipoPqrs' => $objtipoPqrs, 'tipoPqrs' => $tipoPqrs, 'objestado' => $objestado, 'estadoPqrs', $estadoPqrs)) ?>
