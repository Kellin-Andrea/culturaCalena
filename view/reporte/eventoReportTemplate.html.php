        ...
        <div class="row">
            <div class="box">
                ...
                <div class="col-md-12">
                    ...
                    <p><a class="btn btn-success btn-lg" target="popup" href="<?php  echo routing::getInstance()->getUrlWeb('reporte', 'eventoReportPdf'); ?>" role="button"> <?php  echo i18n::__('printReport') ?></a></p>
