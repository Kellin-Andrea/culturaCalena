...
<?php $ima = eventoTableClass::IMAGEN ?>
        ...
        <div class="form-group">
          ...
          <div class="col-lg-7">
            ...
            <input type="file" class="form-control" id="<?php echo eventoTableClass::getNameField(eventoTableClass::IMAGEN, true) ?>"  name="<?php echo eventoTableClass::getNameField(eventoTableClass::IMAGEN, true) ?>"
                   value="<?php echo (session::getInstance()->hasFlash(eventoTableClass::getNameField(eventoTableClass::IMAGEN, true)) === true) ? request::getInstance()->getPost(eventoTableClass::getNameField(eventoTableClass::IMAGEN, true)) : ((( isset($objevento) == true ) ? $objevento[0]->$ima : '' )) ?>">
          </div>
        </div>
