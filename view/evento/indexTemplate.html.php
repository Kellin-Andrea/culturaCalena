                            ...
                            <ul class="dropdown-menu-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
                                ...
                                <li class="dropdown-content">
                                    <ul class="dropdown-menu dropdown-navbar">
                                        <li>
                                            <a >
                                                <form id="frmTraductor" action="<?php echo routing::getInstance()->getUrlWeb('evento', 'traductor') ?>" method="POST">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="container container-fluid">
                                                ...
                                                <form   id="frmDeleteAll" action="<?php echo routing::getInstance()->getUrlWeb('evento', 'deleteSelect') ?>" method="POST">
                                                    ...
                                                    <table class="table table-bordered table-hover">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <div class="modal fade" id="myModalDelete<?php echo $evento->$id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            ¿Desea Eliminar el registro <?php echo $evento->nombre ?> ?
                                                                        </div>
                                                                        <div class="modal-footer">
                                                                            <button type="button" class="btn btn-primary" data-dismiss="modal">Cancelar</button>
                                                                            <button type="button" class="btn btn-danger"onclick="eliminar(<?php echo $evento->$id ?>, '<?php echo eventoTableClass::getNameField(eventoTableClass::ID, true) ?>', '<?php echo routing::getInstance()->getUrlWeb('evento', 'delete') ?> ')">Confirmar Eliminar</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <form id="frmDelete" action="<?php echo routing::getInstance()->getUrlWeb('evento', 'delete') ?>" method="POST">
                                                    ...
                                                    <a href="<?php echo routing::getInstance()->getUrlWeb('evento', 'insert') ?>" type="button" class="btn btn-info"><?php echo i18n::__('create') ?></a>
