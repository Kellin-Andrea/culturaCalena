              ...
              <ul class="dropdown-menu-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
                ...
                <li class="dropdown-content">
                  <ul class="dropdown-menu dropdown-navbar">
                    <li>
                      <a >
                        <form id="frmTraductor" action="<?php echo routing::getInstance()->getUrlWeb('localidad', 'traductor') ?>" method="POST">
                  ...
                  <div class="page-content">
                    ...
                    <div class="row">
                      ...
                      <div class="container container-fluid">
                        <h1><i class="glyphicon glyphicon-map-marker"></i> <?php echo i18n::__('eventlocalitysManagement') ?></h1>
                        <form id="frmDeleteAll" action="<?php echo routing::getInstance()->getUrlWeb('localidad', 'deleteSelect') ?>" method="POST">
                          ...
                          <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                              ...
                              <?php foreach ($objlocal as $localidad): ?>
                                <tr>
                                  <td><input type="checkbox" name="chk[]" value="<?php echo $localidad->id ?>"></td>
                                  <td><?php echo $localidad->nombre ?></td>
                                  <td>
                                    <a href="<?php echo routing::getInstance()->getUrlWeb('localidad', 'edit', array(localidadTableClass::ID => $localidad->$id)) ?>" class="btn btn-info btn-xs"><i class=" glyphicon glyphicon-pencil"></i></a>
                                    <a href="#" data-toggle="modal" data-target="#myModalDelete<?php echo $localidad->$id ?>" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i></a>
                                  </td>
                                </tr>

                              <div class="modal fade" id="myModalDelete<?php echo $localidad->$id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                      ¿Desea Eliminar el registro <?php echo $localidad->nombre ?> ?
                                    </div>
                                    <div class="modal-footer">
                                      <button type="button" class="btn btn-primary" data-dismiss="modal">Cancelar</button>
                                      <button type="button" class="btn btn-danger"onclick="eliminar(<?php echo $localidad->$id ?>, '<?php echo localidadTableClass::getNameField(localidadTableClass::ID, true) ?>', '<?php echo routing::getInstance()->getUrlWeb('localidad', 'delete') ?> ')">Confirmar Eliminar</button>
                                    </div>
                                  </div>
                                </div>
                              </div>
                    ...
                    <div class="text-right">
                      Página <select id="slqPaginador" onchange="Paginador(this, '<?php echo routing::getInstance()->getUrlWeb('localidad', 'index') ?>')">
