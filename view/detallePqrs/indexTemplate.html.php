          ...
          <div class="row">
            <div class="col-xs-12">
              ...
              <div class="row">
                ...
                <div class="container container-fluid">
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                ¿<?php echo i18n::__('are_sure_delete_this_register')?><?php echo $detalle->respuesta ?> ?
                              </div>
                              <div class="modal-footer">
                                <button type="button" class="btn btn-primary" data-dismiss="modal"><?php echo i18n::__('cancel')?></button>
                                <button type="button" class="btn btn-danger"onclick="eliminar(<?php echo $detalle->$id ?>, '<?php echo detallePqrsTableClass::getNameField(detallePqrsTableClass::ID, true) ?>', '<?php echo routing::getInstance()->getUrlWeb('detallePqrs', 'delete') ?> ')"><?php echo i18n::__('confirm')?></button>
                              </div>
                            </div>
                          </div>
                        </div>
                  ...
                  <form id="frmDelete" action="<?php echo routing::getInstance()->getUrlWeb('detallePqrs', 'delete') ?>" method="POST">
                    ...
                    <a id="boton" href="<?php echo routing::getInstance()->getUrlWeb('detallePqrs', 'insert') ?>" type="button" class="btn btn-info" class="btn btn-danger btn-xs"> <i class="glyphicon glyphicon-certificate"></i></a>
              ...
              <div class="text-right">
                Página <select id="slqPaginador" onchange="Paginador(this, '<?php echo routing::getInstance()->getUrlWeb('detallePqrs', 'index') ?>')">
