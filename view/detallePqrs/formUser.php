                    ...
                    <div class="col-sm-7">
                        ...
                        <select  class="form-control" id="<?php echo usuarioTableClass::getNameField(usuarioTableClass::ID, true) ?>"  name="<?php echo usuarioTableClass::getNameField(usuarioTableClass::ID, true) ?>">
                            ...
                            <?php foreach ($objUsuarios as $usuario): ?>
                                <option value="<?php echo $usuario->$id ?>"<?php echo (isset($objdetalle)) ? ($usuario->id === $objdetalle[0]->usuario_id) ? 'selected' : '' : '' ?>><?php echo usuarioTableClass::getNombreById($usuario->id) ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
