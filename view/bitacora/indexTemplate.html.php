...
<?php $obs = bitacoraTableClass::OBSERVACION ?>
<?php $reg = bitacoraTableClass::REGISTRO ?>
                            ...
                            <ul class="dropdown-menu-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
                                ...
                                <li class="dropdown-content">
                                    <ul class="dropdown-menu dropdown-navbar">
                                        <li>
                                            <a >
                                                <form id="frmTraductor" action="<?php echo routing::getInstance()->getUrlWeb('bitacora', 'traductor') ?>" method="POST">
                                    ...
                                    <div class="page-content">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="container container-fluid">
                                                <h1><i class="glyphicon glyphicon-certificate"></i> <?php echo i18n::__('showLogBook') ?></h1>
                                                    ...
                                                    <table class="table table-bordered table-hover">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th><?php echo i18n::__('register') ?></th>
                                                                <th><?php echo i18n::__('date') ?></th>

                                                            </tr>
                                                        <tbody>

                                                            <?php foreach ($objbitacora as $bita): ?>
                                                                <tr>
                                                                    <td><input type="checkbox" name="chk[]" value="<?php echo $bita->id ?>"></td>
                                                                    <td><?php echo $bita->accion ?></td>
                                                                    <td><?php echo $bita->tabla ?></td>
                                                                    <td><?php echo $bita->observacion ?></td>
                                                                    <td><?php echo $bita->registro ?></td>
                                                                    <td><?php echo $bita->fecha ?></td>
