                            ...
                            <ul class="dropdown-menu-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
                                ...
                                <li class="dropdown-content">
                                    <ul class="dropdown-menu dropdown-navbar">
                                        <li>
                                            <a >
                                                <form id="frmTraductor" action="<?php echo routing::getInstance()->getUrlWeb('datoUsuario', 'traductor') ?>" method="POST">
                                                    ...
                                                    <table class="table table-bordered table-hover">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th><?php echo i18n::__('birth_day') ?></th>
                                                                <th><?php echo i18n::__('locality') ?></th>
                                                                <th><?php echo i18n::__('document_type') ?></th>
                                                                <th><?php echo i18n::__('organizations') ?></th>
                                                                <th><?php echo i18n::__('actions') ?></th>
                                                            </tr>
                                                        <tbody>

                                                            <?php foreach ($objdatos as $datos): ?>
                                                                <tr>
                                                                    <td><input type="checkbox" name="chk[]" value="<?php echo $datos->id ?>"></td>
                                                                    ...
                                                                    <td>
                                                                        <a href="<?php echo routing::getInstance()->getUrlWeb('datoUsuario', 'edit', array(datoUsuarioTableClass::ID => $datos->$id)) ?>" class="btn btn-info btn-xs"><i class=" glyphicon glyphicon-pencil"></i></a>
                                                                        <a href="#" data-toggle="modal" data-target="#myModalDelete<?php echo $datos->$id ?>" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i></a>
                                                                    </td>
                                                                </tr>

                                                            <div class="modal fade" id="myModalDelete<?php echo $datos->$id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
