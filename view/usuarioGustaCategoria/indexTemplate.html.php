                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="container container-fluid">
                                                        <h1><i class="glyphicon glyphicon-usd"></i> <?php echo i18n::__('events_like_me_Management') ?> </h1>
                                                        ...
                                                        <form id="frmDelete" action="<?php echo routing::getInstance()->getUrlWeb('usuarioGustaCategoria', 'delete') ?>" method="POST">
                                                            ...
                                                            <a href="<?php echo routing::getInstance()->getUrlWeb('usuarioGustaCategoria', 'insert') ?>" type="button" class="btn btn-info"><?php echo i18n::__('create') ?></a>
