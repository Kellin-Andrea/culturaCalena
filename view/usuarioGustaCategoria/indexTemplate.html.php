...
<?php $usu = usuarioGustaCategoriaTableClass::USUARIO_ID ?>
              ...
              <ul class="dropdown-menu-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
                ...
                <li class="dropdown-content">
                  <ul class="dropdown-menu dropdown-navbar">
                    <li>
                      <a >
                        <form id="frmTraductor" action="<?php echo routing::getInstance()->getUrlWeb('usuarioGustaCategoria', 'traductor') ?>" method="POST">
                        ...
                        <div class="row">
                          ...
                          <div class="container container-fluid">
                            ...
                            <form id="frmDeleteAll" action="<?php echo routing::getInstance()->getUrlWeb('usuarioGustaCategoria', 'deleteSelect') ?>" method="POST">
                              ...
                              <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                  ...
                                  <div class="modal fade" id="myModalDelete<?php echo $usgusca->$id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                      <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                          ¿Desea Eliminar el registro <?php echo $usgusca->usuario_id ?> ?
                                        </div>
                                        <div class="modal-footer">
                                          <button type="button" class="btn btn-primary" data-dismiss="modal">Cancelar</button>
                                          <button type="button" class="btn btn-danger"onclick="eliminar(<?php echo $usgusca->$id ?>, '<?php echo usuarioGustaCategoriaTableClass::getNameField(usuarioGustaCategoriaTableClass::ID, true) ?>', '<?php echo routing::getInstance()->getUrlWeb('usuarioGustaCategoria', 'delete') ?> ')">Confirmar Eliminar</button>
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                            ...
                            <form id="frmDelete" action="<?php echo routing::getInstance()->getUrlWeb('usuarioGustaCategoria', 'delete') ?>" method="POST">
                              ...
                              <a id="boton" href="<?php echo routing::getInstance()->getUrlWeb('usuarioGustaCategoria', 'insert') ?>" type="button" class="btn btn-info"><i class="fa fa-thumbs-up"></i></a>
                            ...
                            <div class="text-right">
                              Página <select id="slqPaginador" onchange="Paginador(this, '<?php echo routing::getInstance()->getUrlWeb('usuarioGustaCategoria', 'index') ?>')">
