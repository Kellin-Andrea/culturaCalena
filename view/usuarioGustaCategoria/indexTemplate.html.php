                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                ¿<?php echo i18n::__('are_sure_delete_this_register')?> <?php echo $usgusca->usuario_id ?> ?
                              </div>
                              <div class="modal-footer">
                                <button type="button" class="btn btn-primary" data-dismiss="modal"><?php echo i18n::__('cancel')?></button>
                                <button type="button" class="btn btn-danger"onclick="eliminar(<?php echo $usgusca->$id ?>, '<?php echo usuarioGustaCategoriaTableClass::getNameField(usuarioGustaCategoriaTableClass::ID, true) ?>', '<?php echo routing::getInstance()->getUrlWeb('usuarioGustaCategoria', 'delete') ?> ')"><?php echo i18n::__('confirm')?></button>
                              </div>
                            </div>
                          </div>
                        </div>
