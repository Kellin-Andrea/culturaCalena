                            ...
                            <ul class="dropdown-menu-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
                                ...
                                <li class="dropdown-content">
                                    <ul class="dropdown-menu dropdown-navbar">
                                        <li>
                                            <a >
                                                <form id="frmTraductor" action="<?php echo routing::getInstance()->getUrlWeb('usuarioCredencial', 'traductor') ?>" method="POST">
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="container container-fluid">
                                                        <h1><i class="glyphicon glyphicon-user"></i> <?php echo i18n::__('credentialManagement') ?></h1>
                                                        <form id="frmDeleteAll" action="<?php echo routing::getInstance()->getUrlWeb('usuarioCredencial', 'deleteSelect') ?>" method="POST">
                                                            ...
                                                            <table class="table table-bordered table-hover">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <?php foreach ($objCredenciales as $usuario): ?>
                                                                        <tr>
