                            ...
                            <ul class="dropdown-menu-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
                                ...
                                <li class="dropdown-content">
                                    <ul class="dropdown-menu dropdown-navbar">
                                        <li>
                                            <a >
                                                <form id="frmTraductor" action="<?php echo routing::getInstance()->getUrlWeb('tipoPqrs', 'traductor') ?>" method="POST">
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="container container-fluid">
                                                        <h1><i class="glyphicon glyphicon-certificate"></i> <?php echo i18n::__('feedbackTypeManagement') ?> </h1>
                                                        <form id="frmDeleteAll" action="<?php echo routing::getInstance()->getUrlWeb('tipoPqrs', 'deleteSelect') ?>" method="POST">
                                                            ...
                                                            <table class="table table-bordered table-hover">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <?php foreach ($objtipoPqrs as $tipoPqrs): ?>
                                                                        <tr>
                                                                            <td><input type="checkbox" name="chk[]" value="<?php echo $tipoPqrs->id ?>"></td>
                                                                            <td><?php echo $tipoPqrs->nombre ?></td>
                                                                            <td>
                                                                                <a href="<?php echo routing::getInstance()->getUrlWeb('tipoPqrs', 'edit', array(tipoPqrsTableClass::ID => $tipoPqrs->$id)) ?>" class="btn btn-info btn-xs"><i class=" glyphicon glyphicon-pencil"></i></a>
                                                                                <a href="#" data-toggle="modal" data-target="#myModalDelete<?php echo $tipoPqrs->$id ?>" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i></a>
                                                                            </td>
                                                                        </tr>

                                                                    <div class="modal fade" id="myModalDelete<?php echo $tipoPqrs->$id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                                        <div class="modal-dialog">
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    ¿Desea Eliminar el registro <?php echo $tipoPqrs->nombre ?> ?
                                                                                </div>
                                                                                <div class="modal-footer">
                                                                                    <button type="button" class="btn btn-primary" data-dismiss="modal">Cancelar</button>
                                                                                    <button type="button" class="btn btn-danger"onclick="eliminar(<?php echo $tipoPqrs->$id ?>, '<?php echo tipoPqrsTableClass::getNameField(tipoPqrsTableClass::ID, true) ?>', '<?php echo routing::getInstance()->getUrlWeb('tipoPqrs', 'delete') ?> ')">Confirmar Eliminar</button>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <form id="frmDelete" action="<?php echo routing::getInstance()->getUrlWeb('tipoPqrs', 'delete') ?>" method="POST">
                                                            <input type="hidden" id="idDelete" name="<?php echo tipoPqrsTableClass::getNameField(tipoPqrsTableClass::ID, true) ?>">

                                                            <a href="<?php echo routing::getInstance()->getUrlWeb('tipoPqrs', 'insert') ?>" type="button" class="btn btn-info"><?php echo i18n::__('create') ?></a>
                                                          ...
                                                          <div class="text-right">
                                                                Página <select id="slqPaginador" onchange="Paginador(this, '<?php echo routing::getInstance()->getUrlWeb('tipoPqrs', 'index') ?>')">
