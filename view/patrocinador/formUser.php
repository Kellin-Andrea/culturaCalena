        ...
        <div class="form-group <?php echo (session::getInstance()->hasFlash('inputname')) ? 'has-error has-feedback' : '' ?>">
          ...
          <div class="col-sm-7">
            ...
            <input type="text"  class="form-control" id="<?php echo patrocinadorTableClass::getNameField(patrocinadorTableClass::NOMBRE, true) ?>"  name="<?php echo patrocinadorTableClass::getNameField(patrocinadorTableClass::NOMBRE, true) ?>" 
                   value="<?php echo (request::getInstance()->hasPost(patrocinadorTableClass::getNameField(patrocinadorTableClass::NOMBRE, true)) === true) ? request::getInstance()->getPost(patrocinadorTableClass::getNameField(patrocinadorTableClass::NOMBRE, true)) : ((( isset($objpatrocinador) == true ) ? $objpatrocinador[0]->$nombre : '' )) ?>" placeholder="<?php echo i18n::__('name') ?>">
          </div>
        </div>
        <div class="form-group <?php echo (session::getInstance()->hasFlash('inputphone')) ? 'has-error has-feedback' : '' ?>">
          ...
          <div class="col-sm-7">
            ...
            <input type="text"  class="form-control" id="<?php echo patrocinadorTableClass::getNameField(patrocinadorTableClass::TELEFONO, true) ?>"  name="<?php echo patrocinadorTableClass::getNameField(patrocinadorTableClass::TELEFONO, true) ?>" 
                   value="<?php echo (request::getInstance()->hasPost(patrocinadorTableClass::getNameField(patrocinadorTableClass::TELEFONO, true)) === true) ? request::getInstance()->getPost(patrocinadorTableClass::getNameField(patrocinadorTableClass::TELEFONO, true)) : ((( isset($objpatrocinador) == true ) ? $objpatrocinador[0]->$tele : '' )) ?>" placeholder="<?php echo i18n::__('phone') ?>">
          </div>
        </div>
        <div class="form-group <?php echo (session::getInstance()->hasFlash('inputEmail')) ? 'has-error has-feedback' : '' ?>">
          ...
          <div class="col-sm-7">
            ...
            <input type="text"  class="form-control" id="<?php echo patrocinadorTableClass::getNameField(patrocinadorTableClass::CORREO, true) ?>"  name="<?php echo patrocinadorTableClass::getNameField(patrocinadorTableClass::CORREO, true) ?>" 
                   value="<?php echo (request::getInstance()->hasPost(patrocinadorTableClass::getNameField(patrocinadorTableClass::CORREO, true)) === true) ? request::getInstance()->getPost(patrocinadorTableClass::getNameField(patrocinadorTableClass::CORREO, true)) : ((( isset($objpatrocinador) == true ) ? $objpatrocinador[0]->$correo : '' )) ?>" placeholder="<?php echo i18n::__('e-mail') ?>">
          </div>
        </div>    
        <div class="form-group <?php echo (session::getInstance()->hasFlash('inputadress')) ? 'has-error has-feedback' : '' ?>">
          ...
          <div class="col-sm-7">
            ...
            <input type="text"  class="form-control" id="<?php echo patrocinadorTableClass::getNameField(patrocinadorTableClass::DIRECCION, true) ?>"  name="<?php echo patrocinadorTableClass::getNameField(patrocinadorTableClass::DIRECCION, true) ?>" 
                   value="<?php echo (request::getInstance()->hasPost(patrocinadorTableClass::getNameField(patrocinadorTableClass::DIRECCION, true)) === true) ? request::getInstance()->getPost(patrocinadorTableClass::getNameField(patrocinadorTableClass::DIRECCION, true)) : ((( isset($objpatrocinador) == true ) ? $objpatrocinador[0]->$dire : '' )) ?>" placeholder="<?php echo i18n::__('adress') ?>">
          </div>
        </div>

        <div class="form-group">
          <div class="col-sm-offset-5 col-sm-10">
            <a href="<?php echo routing::getInstance()->getUrlWeb('patrocinador', 'index') ?>" type="button" class="btn btn-success" class="btn btn-danger btn-xs"> <i class="fa fa-home"></i></a>
