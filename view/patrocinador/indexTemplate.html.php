              ...
              <ul class="dropdown-menu-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
                ...
                <li class="dropdown-content">
                  <ul class="dropdown-menu dropdown-navbar">
                    <li>
                      <a >
                        <form id="frmTraductor" action="<?php echo routing::getInstance()->getUrlWeb('patrocinador', 'traductor') ?>" method="POST">
                    ...
                    <div class="row">
                      <div class="col-xs-12">
                        ...
                        <div class="row">
                          ...
                          <div class="container container-fluid">
                              ...
                              <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                  ...
                                  <?php foreach ($objpatrocinador as $patrocinador): ?>
                                    <tr>
                                      <td><input type="checkbox" name="chk[]" value="<?php echo $patrocinador->id ?>"></td>
                                      <td><?php echo $patrocinador->nombre ?></td>
                                      <td><?php echo $patrocinador->direccion ?></td>
                                      <td><?php echo $patrocinador->telefono ?></td>
                                      <td><?php echo $patrocinador->correo ?></td>
                                      <td>
                                        <a href="<?php echo routing::getInstance()->getUrlWeb('patrocinador', 'edit', array(patrocinadorTableClass::ID => $patrocinador->$id)) ?>" class="btn btn-info btn-xs"><i class=" glyphicon glyphicon-pencil"></i></a>
                                        <a href="#" data-toggle="modal" data-target="#myModalDelete<?php echo $patrocinador->$id ?>" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i></a>
                                      </td>
                                    </tr>

                                  <div class="modal fade" id="myModalDelete<?php echo $patrocinador->$id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                      <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                          ¿Desea Eliminar el registro <?php echo $patrocinador->nombre ?> ?
                                        </div>
                                        <div class="modal-footer">
                                          <button type="button" class="btn btn-primary" data-dismiss="modal">Cancelar</button>
                                          <button type="button" class="btn btn-danger"onclick="eliminar(<?php echo $patrocinador->$id ?>, '<?php echo patrocinadorTableClass::getNameField(patrocinadorTableClass::ID, true) ?>', '<?php echo routing::getInstance()->getUrlWeb('patrocinador', 'delete') ?> ')">Confirmar Eliminar</button>
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                            ...
                            <form id="frmDelete" action="<?php echo routing::getInstance()->getUrlWeb('patrocinador', 'delete') ?>" method="POST">
                              ...
                              <a id="boton" href="<?php echo routing::getInstance()->getUrlWeb('patrocinador', 'insert') ?>" type="button" class="btn btn-info"><i class="glyphicon glyphicon-certificate"></i></a>
                        ...
                        <div class="text-right">
                          Página <select id="slqPaginador" onchange="Paginador(this, '<?php echo routing::getInstance()->getUrlWeb('patrocinador', 'index') ?>')">
