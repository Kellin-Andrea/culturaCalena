...
<div class="container">
        ...
        <div class='row'>
        <div class='col-lg-3' id='sizeImg'><a href='#' data-toggle='modal' data-target='#myModalEvento$data->id' title='Image 1'><img src=" . routing::getInstance()->getUrlImgUpload($data->imagen) . " class='thumbnail img-responsive'></a></div>
      
  

   
  <div class='modal fade' id='myModalEvento$data->id' name='view' role='dialog'>
  <div class='modal-dialog'>
  <div class='modal-content'>
  <div class='modal-header'>
  <button type='button' class='close' data-dismiss='modal' aria-label='Close'><span aria-hidden='true'>&times;</span></button>
  <h4 class='modal-title'> $data->nombre</h4>
  </div>
  <div class='modal-body'>
  <p>$data->direccion</p>
  <p>Fecha Inicial: $data->fecha_inicial_evento</p>
  <p>Fecha final: $data->fecha_final_evento</p>
