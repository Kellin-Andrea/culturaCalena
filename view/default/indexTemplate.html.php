                                                ...
                                                <div class="row">
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form  class="form-horizontal" id="filterForm"  role="form" method="POST" action="<?php echo routing::getInstance()->getUrlWeb('default', 'index') ?>">
                                                    ...
                                                    <div class="container container-fluid">
                                                            ...
                                                            <table class="table table-bordered table-hover">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th><?php echo i18n::__('dateCreate') ?></th>
                                                                    ...
                                                                    <div class="modal fade" id="myModalDelete<?php echo $usuario->id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                                        <div class="modal-dialog">
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    ¿Desea Eliminar el registro <?php echo $usuario->$usu ?> ?
                                                                                </div>
                                                                                <div class="modal-footer">
                                                        ...
                                                        <form id="frmDelete" action="<?php echo routing::getInstance()->getUrlWeb('default', 'delete') ?>" method="POST">
                                                            ...
                                                            <a href="<?php echo routing::getInstance()->getUrlWeb('default', 'insert') ?>" type="button" class="btn btn-success"><?php echo i18n::__('new') ?></a>
                                                            <button type="button" class="btn btn-primary " data-toggle="modal" data-target="#myModalFilters"><?php echo i18n::__('filter') ?></button>
                                                            <a href="javascript:eliminarMasivo()" type="button" class="btn btn-danger" id="btnDeleteMasivo"><?php echo i18n::__('deleteSelection') ?></a>
                                                            <a href="<?php echo routing::getInstance()->getUrlWeb('default', 'deleteFilters') ?>" class="btn btn-danger "><?php echo i18n::__('deleteFilter') ?></a>
                                                            <a href="<?php echo routing::getInstance()->getUrlWeb('default', 'report') ?>" type="button" class="btn btn-info"><?php echo i18n::__('printReportPdf') ?></a> 
