              ...
              <ul class="dropdown-menu-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
                ...
                <li class="dropdown-content">
                  <ul class="dropdown-menu dropdown-navbar">
                    <li>
                      <a >
                        <form id="frmTraductor" action="<?php echo routing::getInstance()->getUrlWeb('organizacion', 'traductor') ?>" method="POST">
                      ...
                      <div class="col-xs-12">
                        ...
                        <div class="row">
                          ...
                          <div class="container container-fluid">
                            <h1><i class="glyphicon glyphicon-certificate"></i><?php echo i18n::__('organizationManagement') ?> </h1>
                            <form id="frmDeleteAll" action="<?php echo routing::getInstance()->getUrlWeb('organizacion', 'deleteSelect') ?>" method="POST">
                              ...
                              <table class="table table-bordered table-hover">
                                <thead>
                                  <tr>
                                    ...
                                    <th><?php echo i18n::__('facsimil') ?></th>
                                ...
                                <tbody>
                                  ...
                                  <?php foreach ($objorganizacion as $organizacion): ?>
                                    <tr>
                                      <td><input type="checkbox" name="chk[]" value="<?php echo $organizacion->id ?>"></td>
                                      <td><?php echo $organizacion->nombre ?></td>
                                      <td><?php echo $organizacion->direccion ?></td>
                                      <td><?php echo $organizacion->telefono ?></td>
                                      <td><?php echo $organizacion->fax ?></td>
                                      <td><?php echo $organizacion->correo ?></td>
                                      <td><?php echo $organizacion->pagina_web ?></td>
                                      <td>
                                        <a href="<?php echo routing::getInstance()->getUrlWeb('organizacion', 'edit', array(organizacionTableClass::ID => $organizacion->$id)) ?>" class="btn btn-info btn-xs"><i class=" glyphicon glyphicon-pencil"></i></a>
                                        <a href="#" data-toggle="modal" data-target="#myModalDelete<?php echo $organizacion->$id ?>" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i></a>
                                      </td>
                                    </tr>

                                  <div class="modal fade" id="myModalDelete<?php echo $organizacion->$id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            ...
                            <form id="frmDelete" action="<?php echo routing::getInstance()->getUrlWeb('organizacion', 'delete') ?>" method="POST">
                              ...
                              <a id="boton" href="<?php echo routing::getInstance()->getUrlWeb('organizacion', 'insert') ?>" type="button" class="btn btn-info"><i class="glyphicon glyphicon-certificate"></i></a>
                        ...
                        <div class="text-right">
                          Página <select id="slqPaginador" onchange="Paginador(this, '<?php echo routing::getInstance()->getUrlWeb('organizacion', 'index') ?>')">
