...
<div class="container container-fluid">
  ...
  <form class="form-horizontal" role="form" method="POST" action="<?php echo routing::getInstance()->getUrlWeb('tipoDocumento', ((isset($objtipoDocumento)) ? 'update' : 'create')) ?>">
    ...
    <div class="col-sm-offset-5 col-sm-10">
        <a href="<?php echo routing::getInstance()->getUrlWeb('tipoDocumento', 'index') ?>" type="button" class="btn btn-success" class="btn btn-danger btn-xs"> <i class="fa fa-home"></i></a>
