              ...
              <ul class="dropdown-menu-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
                ...
                <li class="dropdown-content">
                  <ul class="dropdown-menu dropdown-navbar">
                    <li>
                      <a >
                        <form id="frmTraductor" action="<?php echo routing::getInstance()->getUrlWeb('tipoDocumento', 'traductor') ?>" method="POST">
                      ...
                      <div class="col-xs-12">
                        ...
                        <div class="row">
                          ...
                          <div class="container container-fluid">
                            <h1><i class="glyphicon glyphicon-certificate"></i> <?php echo i18n::__('IdTypeManagement') ?> </h1>
                                ...
                                <tbody>
                                  ...
                                  <?php foreach ($objtipoDocumento as $tipoDocumento): ?>
                                    <tr>
                                      ...
                                      <td>
                                        <a href="<?php echo routing::getInstance()->getUrlWeb('tipoDocumento', 'edit', array(tipoDocumentoTableClass::ID => $tipoDocumento->$id)) ?>" class="btn btn-info btn-xs"><i class=" glyphicon glyphicon-pencil"></i></a>
                                        <a href="#" data-toggle="modal" data-target="#myModalDelete<?php echo $tipoDocumento->$id ?>" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i></a>
                                      </td>
                                    </tr>

                                  <div class="modal fade" id="myModalDelete<?php echo $tipoDocumento->$id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                      <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                          ¿Desea Eliminar el registro <?php echo $tipoDocumento->nombre ?> ?
                                        </div>
                                        <div class="modal-footer">
                                          <button type="button" class="btn btn-primary" data-dismiss="modal">Cancelar</button>
                                          <button type="button" class="btn btn-danger"onclick="eliminar(<?php echo $tipoDocumento->$id ?>, '<?php echo tipoDocumentoTableClass::getNameField(tipoDocumentoTableClass::ID, true) ?>', '<?php echo routing::getInstance()->getUrlWeb('tipoDocumento', 'delete') ?> ')">Confirmar Eliminar</button>
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                            ...
                            <form id="frmDelete" action="<?php echo routing::getInstance()->getUrlWeb('tipoDocumento', 'delete') ?>" method="POST">
                              ...
                              <a id="boton" href="<?php echo routing::getInstance()->getUrlWeb('tipoDocumento', 'insert') ?>" type="button" class="btn btn-info"><i class="glyphicon glyphicon-certificate"></i></a>
                        ...
                        <div class="text-right">
                          Página <select id="slqPaginador" onchange="Paginador(this, '<?php echo routing::getInstance()->getUrlWeb('tipoDocumento', 'index') ?>')">
