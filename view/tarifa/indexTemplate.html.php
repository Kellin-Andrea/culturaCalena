                            ...
                            <ul class="dropdown-menu-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
                                ...
                                <li class="dropdown-content">
                                    <ul class="dropdown-menu dropdown-navbar">
                                        <li>
                                            <a >
                                                <form id="frmTraductor" action="<?php echo routing::getInstance()->getUrlWeb('tarifa', 'traductor') ?>" method="POST">
                                                    ...
                                                    <div class="container container-fluid">
                                                        ...
                                                        <form id="frmDelete" action="<?php echo routing::getInstance()->getUrlWeb('tarifa', 'delete') ?>" method="POST">
                                                          ...
                                                          <div class="text-right">
                                                                Página <select id="slqPaginador" onchange="Paginador(this, '<?php echo routing::getInstance()->getUrlWeb('tarifa', 'index') ?>')">
