            ...
            <div class="col-xs-12">
              ...
              <div class="row">
                ...
                <div class="container container-fluid">
                  <h1><i class="glyphicon glyphicon-user"></i> <?php echo i18n::__('eventManagement') ?></h1>
                  <form id="frmDeleteAll" action="<?php  echo routing::getInstance()->getUrlWeb('eventActived', 'deleteSelect') ?>" method="POST">
                    ...
                    <table class="table table-bordered table-hover">
                      ...
                      <tbody>
                        ...
                        <?php foreach ($objEvento as $usuario): ?>
                          <tr>
                            <td><input type="checkbox" name="chk[]" value="<?php echo $usuario->id ?>"></td>
                            <td><?php echo $usuario->evento ?></td>
                            <td><?php echo $usuario->categoria?></td>
                            <td><?php echo $usuario->user_name ?></td>
                            <td>
                              <a href="" class="btn btn-info btn-xs" onclick="activar(<?php   echo $usuario->id  ?>, '<?php  echo eventoTableClass::getNameField(usuarioTableClass::ID, true) ?>', '<?php  echo routing::getInstance()->getUrlWeb('eventActived', 'actived') ?> ')"><i class="fa fa-check-circle-o"></i> <?php  echo i18n::__('activateEvent')?></a>
                              ...
                              <a href="#" data-toggle="modal" data-target="#myModalVer<?php  echo $usuario->id  ?>" class="btn btn-warning btn-xs"><i class="glyphicon glyphicon-eye-open"></i></a>
                        ...
                        <div class="modal fade" id="myModalDelete<?php echo $usuario->id  ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <?php echo i18n::__('are_sure_delete_this_register') ?> <?php  echo $usuario->evento ?> 
                              </div>
                              <div class="modal-footer">
                                <button type="button" class="btn btn-primary" data-dismiss="modal"><?php  echo i18n::__('cancel') ?></button>
                                <button type="button" class="btn btn-danger" onclick="eliminar(<?php  echo $usuario->id  ?>, '<?php  echo eventoTableClass::getNameField(eventoTableClass::ID, true) ?>', '<?php  echo routing::getInstance()->getUrlWeb('eventActived', 'delete') ?> ')"><?php echo i18n::__('confirm') ?></button>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="modal fade" id="myModalVer<?php echo $usuario->id  ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                          <div class="modal-dialog">
                            <div class="modal-content">
                              <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                <h4 class="modal-title" id="myModalLabel"><?php echo i18n::__('description') ?> </h4>
                              </div>
                              <div class="modal-body">
                  ...
                  <form id="frmDelete" action="<?php // echo routing::getInstance()->getUrlWeb('usuario', 'delete') ?>" method="POST">
                    ...
                    <div class="text-right">
                      Página <select id="slqPaginador" onchange="Paginador(this, '<?php  echo routing::getInstance()->getUrlWeb('eventActived', 'index')   ?>')">
