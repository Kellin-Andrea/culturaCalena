                            ...
                            <ul class="dropdown-menu-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
                                ...
                                <li class="dropdown-content">
                                    <ul class="dropdown-menu dropdown-navbar">
                                        <li>
                                            <a >
                                                <form id="frmTraductor" action="<?php echo routing::getInstance()->getUrlWeb('categoria', 'traductor') ?>" method="POST">
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="container container-fluid">
                                                        <h1><i class="glyphicon glyphicon-certificate"></i><?php echo i18n::__('categoryManagement') ?> </h1>
                                                        <form id="frmDeleteAll" action="<?php echo routing::getInstance()->getUrlWeb('categoria', 'deleteSelect') ?>" method="POST">
                                                                        ...
                                                                        <?php foreach ($objcategoria as $categoria): ?>
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <a href="<?php echo routing::getInstance()->getUrlWeb('categoria', 'edit', array(categoriaTableClass::ID => $categoria->$id)) ?>" class="btn btn-success btn-xs"><i class=" glyphicon glyphicon-pencil"></i></a>
                                                                                    <a href="#" data-toggle="modal" data-target="#myModalDelete<?php echo $categoria->$id ?>" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i></a>
                                                                                </td>
                                                                            </tr>

                                                                        <div class="modal fade" id="myModalDelete<?php echo $categoria->$id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                                            <div class="modal-dialog">
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        ¿Desea Eliminar el registro <?php echo $categoria->nombre ?> ?
                                                                                    </div>
                                                                                    <div class="modal-footer">
                                                                                        <button type="button" class="btn btn-primary" data-dismiss="modal">Cancelar</button>
                                                                                        <button type="button" class="btn btn-danger"onclick="eliminar(<?php echo $categoria->$id ?>, '<?php echo categoriaTableClass::getNameField(categoriaTableClass::ID, true) ?>', '<?php echo routing::getInstance()->getUrlWeb('categoria', 'delete') ?> ')">Confirmar Eliminar</button>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                        ...
                                                        <div class="text-right">
                                                            Página <select id="slqPaginador" onchange="Paginador(this, '<?php echo routing::getInstance()->getUrlWeb('categoria', 'index') ?>')">
                                                        ...
                                                        <form id="frmDelete" action="<?php echo routing::getInstance()->getUrlWeb('categoria', 'delete') ?>" method="POST">
                                                            ...
                                                            <a id="boton" href="<?php echo routing::getInstance()->getUrlWeb('categoria', 'insert') ?>" type="button" class="btn btn-info" class="btn btn-danger btn-xs"> <i class="glyphicon glyphicon-certificate"></i></a>
