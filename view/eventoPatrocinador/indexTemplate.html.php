          ...
          <div class="row">
            <div class="col-xs-12">
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                ¿<?php echo i18n::__('are_sure_delete_this_register')?> <?php echo $eventoPatrocinador->$id ?> ?
                              </div>
                              <div class="modal-footer">
                                <button type="button" class="btn btn-primary" data-dismiss="modal"><?php echo i18n::__('cancel')?></button>
                                <button type="button" class="btn btn-danger"onclick="eliminar(<?php echo $eventoPatrocinador->$id ?>, '<?php echo eventoPatrocinadorTableClass::getNameField(eventoPatrocinadorTableClass::ID, true) ?>', '<?php echo routing::getInstance()->getUrlWeb('eventoPatrocinador', 'delete') ?> ')"><?php echo i18n::__('confirm')?></button>
                              </div>
                            </div>
                          </div>
                        </div>
              ...
              <div class="text-right">
                Página <select id="slqPaginador" onchange="Paginador(this, '<?php echo routing::getInstance()->getUrlWeb('eventoPatrocinador', 'index') ?>')">
